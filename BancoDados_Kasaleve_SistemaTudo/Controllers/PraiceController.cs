...
namespace BancoDados_Kasaleve_SistemaTudo.Controllers
{
    public class PraiceController : Controller
    {
        ...
        {
            var contexto = _context.Praice.Include(p => p.Produto).Include(p => p.TipoProduto);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoProdutoId"] = new SelectList(_context.Clientes, "tipoProdutoId", "tipoProdutoId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("praiceId,praiceValor,ProdutoId,TipoProdutoId")] Praice praice)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "produtoId", "produtoId", praice.ProdutoId);
            ViewData["TipoProdutoId"] = new SelectList(_context.Clientes, "tipoProdutoId", "tipoProdutoId", praice.TipoProdutoId);
            return View(praice);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("praiceId,praiceValor,ProdutoId,TipoProdutoId")] Praice praice)
        {
