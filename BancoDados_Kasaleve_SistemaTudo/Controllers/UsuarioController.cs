...
public class UsuarioController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("UsuarioId,Nome,Email,SenhaHash,CargoId,Cargo,VendedoraId,Vendedora,DataCadastro,Ativo,Tarefas")] Usuario usuario)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? usuarioid, [Bind("UsuarioId,Nome,Email,SenhaHash,CargoId,Cargo,VendedoraId,Vendedora,DataCadastro,Ativo,Tarefas")] Usuario usuario)
    {
