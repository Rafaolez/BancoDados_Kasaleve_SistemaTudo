...
namespace BancoDados_Kasaleve_SistemaTudo.Controllers
{
    public class TipoProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tipoProduto = await _context.Clientes
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var tipoProduto = await _context.Clientes.FindAsync(id);
            if (tipoProduto == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (tipoProduto != null)
            {
                _context.Clientes.Remove(tipoProduto);
            }
        ...
        {
            return _context.Clientes.Any(e => e.tipoProdutoId == id);
        }
    }
}
